...
export default function Show({ team, performance, can }: Props) {
                        ...
                        <Card className="border-none shadow-2xl bg-white dark:bg-neutral-900 rounded-[3rem] overflow-hidden">
                            ...
                            <CardContent className="p-8 space-y-8">
                                ...
                                <div className="space-y-6">
                                    <StatLine label="Birim Gücü (Kadro)" value={team.players.length} max={12} min={6} color="bg-blue-600" />
                                    <StatLine label="Lisanslı Personel" value={licensedCount} max={2} color="bg-amber-500" />
                                    <StatLine label="Firma Personeli" value={companyStaffCount} max={5} color="bg-indigo-400" />
