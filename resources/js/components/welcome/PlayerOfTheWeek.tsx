...
import { staggerContainer, staggerItem, staggerInView, springTransition, useReducedMotion, sectionTitleClass } from "@/lib/motion-presets";
...
export default function PlayerOfTheWeek({ playerOfTheWeek }: PlayerOfTheWeekProps) {
    ...
    return (
        <div className="space-y-8 flex flex-col">
            ...
            <Card className="bg-white/90 backdrop-blur-md border border-orange-100 rounded-[3rem] p-6 md:p-12 shadow-2xl relative overflow-hidden group hover:border-orange-600 transition-all duration-700 flex flex-col justify-center">
